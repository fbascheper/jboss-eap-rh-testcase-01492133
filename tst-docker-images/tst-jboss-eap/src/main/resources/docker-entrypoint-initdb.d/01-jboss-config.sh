...
gosu jboss $JBOSS_CLI -c << EOCLI
    ...
    # Add Postgres driver
    /subsystem=datasources/jdbc-driver=postgresql:add(driver-name=postgresql,driver-module-name=org.postgresql.jdbc41,module-slot=main,driver-xa-datasource-class-name=org.postgresql.xa.PGXADataSource)
